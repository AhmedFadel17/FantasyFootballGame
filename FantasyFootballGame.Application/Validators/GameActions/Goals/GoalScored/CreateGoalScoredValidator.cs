...
{
    public class CreateGoalScoredValidator : AbstractValidator<CreateGoalScoredDto>
    {
        public CreateGoalScoredValidator(IPlayersRepository playersRepository, IGoalsRepository goalsRepository)
        {
            RuleFor(p => p.GoalId)
